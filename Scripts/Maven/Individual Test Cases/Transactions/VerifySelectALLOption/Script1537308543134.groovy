...
WebUI.click(findTestObject('Transactions/span_Select All'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Transactions/SelectedCheckbox'), 30)
