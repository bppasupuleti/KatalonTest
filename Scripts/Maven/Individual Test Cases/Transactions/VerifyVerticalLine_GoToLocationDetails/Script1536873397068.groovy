...
WebUI.waitForElementPresent(findTestObject('Transactions/span_Go_to_Location_Details'), 
    60)

WebUI.click(findTestObject('Transactions/span_Go_to_Location_Details'))

WebUI.waitForElementPresent(findTestObject('Transactions/div_Transaction_Location_Info'), 
    30)
...
WebUI.verifyElementPresent(findTestObject('Transactions/small_IP Address'), 
    0)

String sourceData = WebUI.getText(findTestObject('Transactions/p_Source_Emergepay'), 
...
WebUI.verifyElementPresent(findTestObject('Transactions/small_ComputerName'), 
    0)

WebUI.verifyElementPresent(findTestObject('Transactions/small_CIPSoftware_Version'), 
    0)

String computerDateTIME = WebUI.getText(findTestObject('Transactions/p_Computer_Date_Time_InvalidDate'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Transactions/small_Billing Address'), 
    0)

String terminalDateTIME = WebUI.getText(findTestObject('Transactions/p_Terminal_Date_Time_InvalidDate'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Transactions/small_Billing Zip'), 
    0)
