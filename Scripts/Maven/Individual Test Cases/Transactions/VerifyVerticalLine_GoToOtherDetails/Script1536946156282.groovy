...
WebUI.waitForElementPresent(findTestObject('Transactions/p_TransactionID'), 
    40)
...
WebUI.verifyElementPresent(findTestObject('Transactions/p_ReferenceNumber'), 
    30)

String refernceNumber = WebUI.getText(findTestObject('Transactions/p_ReferenceNumber'), 
...
WebUI.verifyElementPresent(findTestObject('Transactions/p_Transaction_Type'), 
    0)

String transactionType = WebUI.getText(findTestObject('Transactions/p_Transaction_Type'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Transactions/p_ApprovalNumberResult'), 
    30)
