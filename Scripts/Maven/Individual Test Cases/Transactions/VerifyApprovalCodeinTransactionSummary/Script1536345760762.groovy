...
WebUI.click(findTestObject('Transactions/div_Approvalalert'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Transactions/p_Type CreditSale'), 30)

WebUI.verifyElementPresent(findTestObject('Transactions/h4_Transaction summary'), 20)

WebUI.verifyElementPresent(findTestObject('Transactions/p_Sale  0.01'), 20)
